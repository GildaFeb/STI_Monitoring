...
namespace STI_Monitoring.Controllers
{
    public class LogInController : Controller
    {
        ...
        public ActionResult Index(GuestModel e)
        {
            try
            {
                ...
                if (sdr.Read())
                {
                    ...
                    {
                        Session["Email"] = e.Email.ToString();
                        return RedirectToAction("CashierMenu", "Home");
                    }
                    else
                    {
        ...
        public JsonResult AddOtherRequest(VisitModel request)
        {
            return Json(GuestDB.AddNewRequest(request), JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult UpdateTime(VisitModel request)
        { // guard
            return Json(GuestDB.UpdateTime(request), JsonRequestBehavior.AllowGet);
        }
